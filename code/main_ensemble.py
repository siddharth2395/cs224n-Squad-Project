...
from official_eval_helper import get_json_data, generate_answers_prob
...
def main(unused_argv):
    ...
    if FLAGS.mode == "train":
        ...
        with tf.Session(config=config) as sess:
            ...
            answers_dict = generate_answers_prob(sess, qa_model, word2id, qn_uuid_data, context_token_data,
                                                 qn_token_data)
